...
CARHEIGHT = 60
CARSPEED = 3
CARIMG = pygame.image.load("C:/Users/BaoKhoi/Pictures/soldier.png")
CARIMG = pygame.transform.scale(CARIMG, (20, 20))

#kich thuoc vat can/xe xanh
DISTANCE = 200
OBSTACLESSPEED = 2
CHANGESPEED = 0.001
OBSTACLESIMG = pygame.image.load("C:/Users/BaoKhoi/Pictures/soldier_2.png")
OBSTACLESIMG = pygame.transform.scale(OBSTACLESIMG, (20, 20))
#toc do game va hinh nen
BGSPEED = 1.5
BGIMG = pygame.image.load("C:/Users/BaoKhoi/Pictures/background.png")
